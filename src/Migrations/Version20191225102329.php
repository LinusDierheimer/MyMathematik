 ...
 */
final class Version20191225102329 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE pending_email_verification (id INT AUTO_INCREMENT NOT NULL, secret VARCHAR(255) NOT NULL, date DATETIME NOT NULL, user_id INT NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
